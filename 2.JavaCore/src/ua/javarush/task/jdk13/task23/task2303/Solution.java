...
public class Solution {
    ...
    public static final class Constants {
        public static final String SERVER_IS_CURRENTLY_NOT_ACCESSIBLE = "The server is currently " +
                "not accessible.";
        public static final String USER_IS_NOT_AUTHORIZED = "The server is currently not " +
                "accessible.";
