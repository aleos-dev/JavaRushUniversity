...
public class Solution {
    ...
    public static void main(String[] args) {
        try (FileChannel channel = FileChannel.open(Paths.get("/home/aleos/Documents/dev/JavaRushTasks/1.JavaSyntax/src/ua/javarush/task/pro/task15/task1534/1.txt"), StandardOpenOption.READ, StandardOpenOption.WRITE)) {
